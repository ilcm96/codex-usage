...
func TestParseRaw(t *testing.T) {
	raw := []byte(
		`{"timestamp":"2026-02-08T00:00:00Z","type":"session_meta","payload":{"id":"parsed-session","timestamp":"2026-02-08T00:00:00Z","cwd":"/repo/parsed","originator":"codex","source":"cli","cli_version":"1.0.0","model_provider":"openai","git":{"repository_url":"https://github.com/acme/parsed","branch":"main","commit_hash":"abc123"}}}` + "\n" +
			...
			`{"timestamp":"2026-02-08T00:00:06Z","type":"event_msg","payload":{"type":"token_count","info":{"last_token_usage":{"input_tokens":10,"cached_input_tokens":2,"output_tokens":5,"reasoning_output_tokens":1,"total_tokens":16}}}}` + "\n",
	)
	...
	if got.Usages[0].Model != "gpt-5" || got.Usages[0].TotalTokens != 16 || got.Usages[0].CostUSD <= 0 {
